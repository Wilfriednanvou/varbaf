...
4. **Immuabilité du brouillard.** Un mouvement de caisse est immuable dès son enregistrement : il ne se modifie ni ne se supprime, quelle que soit son ancienneté. Toute correction passe par une contre-passation, qui crée un mouvement de sens inverse référençant l'original. Une journée arrêtée est en outre verrouillée en date : un mouvement qui la viserait — ou qui viserait un jour antérieur au dernier arrêté — est enregistré à la date du jour, avec mention de sa date d'origine (RG-27).
