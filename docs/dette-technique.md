...
| DT-14 | La Trésorerie d'un exercice historique (2024, 2025) est muette : aucune section de caisse, aucun mouvement, alors que 24 500 F (2024) et 923 450 F (2025) de ventes réelles y sont rattachées | `varbaf:segmenter-exercices` (02/09) a réaffecté ventes, dépôts et attributions à l'exercice réel de leur propre date — une opération sûre, chaque enregistrement ne portant qu'une seule date. Les 497 encaissements de vente et 18 encaissements de redevance, eux, ont tous été écrits par les imports du 2/09 dans **une seule section de caisse**, celle ouverte pour l'exercice 2026 au moment de l'import — avec une numérotation séquentielle par section et une immuabilité totale (RG-4). Aucun mouvement ne peut être déplacé vers une section 2024 ou 2025 sans soit violer l'immuabilité, soit inventer rétroactivement une section et un arrêté qui n'ont jamais existé — exactement ce que `ServiceImportRegistre` avait déjà refusé de faire pour la même raison | Assumé et documenté. La Trésorerie du panneau reste juste et complète pour l'exercice 2026 — celui qui compte réellement pour l'exploitation courante — et vide pour les deux exercices historiques, qui ne l'ont jamais eue. Un déploiement qui ouvrirait un exercice dès son premier jour n'aurait pas ce défaut |
